...
const questionControllers = __importStar(require("../controllers/questions.controller"));
...
questionRouter.delete("/remove/:id", questionControllers.deleteQuestionController);
// Activate Question
questionRouter.patch("/activate/:id", questionControllers.activateQuestionController);
// Deactivate Question
questionRouter.patch("/deactivate/:id", questionControllers.deactivateQuestionController);
...
questionRouter.get("/paper/:questionPaperId", questionControllers.getQuestionsByPaperController);
