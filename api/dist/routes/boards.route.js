...
const boardControllers = __importStar(require("../controllers/boards.controller"));
const boardRouter = (0, express_1.Router)();
boardRouter.get("/", boardControllers.getAllBoardsController);
boardRouter.get("/active", boardControllers.getAllActiveBoardsController);
...
boardRouter.delete("/remove/:id", boardControllers.removeBoardController);
