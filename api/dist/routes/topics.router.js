...
const topicsController = __importStar(require("../controllers/topics.controller"));
...
topicRouter.get("/section/:sectionId", topicsController.handleGetTopicsBySection);
...
topicRouter.get("/active", topicsController.fetchAllActiveTopics);
