...
const removeSubject = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deletedSubject = yield subjectService.removeSubject(id, performedBy);
        res.status(200).json(deletedSubject);
    }
    catch (error) {
        res.status(500).json({ message: error.message });
...
const fetchAllActiveSubjects = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const subjects = yield subjectService.getAllActiveSubjects();
