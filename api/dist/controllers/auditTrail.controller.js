...
const getAllAuditLogsController = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const logs = yield auditServices.getAllAuditLogs();
...
const getAuditLogByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const log = yield auditServices.getAuditLogById(id);
        if (!log) {
