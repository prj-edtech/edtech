...
exports.fetchAllActiveSections = exports.fetchAllSections = exports.removeSection = exports.softDeleteSection = exports.getSectionsBySubject = exports.updateSection = exports.createSection = void 0;
...
const removeSection = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deletedSection = yield sectionService.removeSection(id, performedBy);
...
const fetchAllActiveSections = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sections = yield sectionService.getAllActiveSections();
...
exports.fetchAllActiveSections = fetchAllActiveSections;
