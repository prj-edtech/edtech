...
exports.removeBoardController = exports.deleteBoardController = exports.updateBoardController = exports.createBoardController = exports.getBoardByIdController = exports.getAllActiveBoardsController = exports.getAllBoardsController = void 0;
...
const getAllActiveBoardsController = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const boards = yield boardServices.getAllActiveBoards();
        res.status(200).json({ success: true, total: boards.length, data: boards });
    }
    catch (error) {
        res.status(400).json({ success: false, message: error.message });
...
exports.getAllActiveBoardsController = getAllActiveBoardsController;
// GET /api/boards/:id
...
const removeBoardController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const board = yield boardServices.removeBoard(id, performedBy);
        res
            .status(200)
