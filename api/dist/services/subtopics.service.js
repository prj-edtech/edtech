...
const removeSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const activeSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield db_1.default.subTopic.update({
        where: {
            id,
        },
        data: {
...
const deactiveSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield db_1.default.subTopic.update({
        where: {
            id,
        },
...
const approveSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const rejectSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const subtopic = yield db_1.default.subTopic.update({
        where: {
            id,
        },
...
const resetSubtopic = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const subtopic = yield db_1.default.subTopic.update({
        where: {
            id,
        },
