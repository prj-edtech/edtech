...
exports.getAllSubjects = exports.softDeleteSubject = exports.updateSubject = exports.getSubjectsByBoardStandard = exports.createSubject = void 0;
...
const updateSubject = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedSubject = yield db_1.default.subject.update({
        where: { id },
        data: {
            isActive: (_c = data.isActive) !== null && _c !== void 0 ? _c : existing.isActive,
